...
public class ModuleLoader
{
	...
	{
		File coredir = new File(System.getProperty("user.dir") + "/../Core/bin/uk.co.pbellchambers.maceswinger.core");
		File newlocdir = new File(OSUtils.getDynamicStorageLocation() + "Mace Swinger/modules/uk.co.pbellchambers.maceswinger.core");
		try
		{
