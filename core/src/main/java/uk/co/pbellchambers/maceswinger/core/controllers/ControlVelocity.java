...
public class ControlVelocity implements Control {
    ...
    public void update(Entity e, Object updateState) {
        ...
        if (e.has(Components.position) && e.has(uk.co.pbellchambers.maceswinger.core.Core.Components.velocity)) {
            Vector2 pos = e.get(Components.position);
            Vector2 velocity = e.get(uk.co.pbellchambers.maceswinger.core.Core.Components.velocity);
