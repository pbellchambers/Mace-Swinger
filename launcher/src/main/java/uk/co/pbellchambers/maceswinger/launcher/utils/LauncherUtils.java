...
import uk.co.pbellchambers.maceswinger.launcher.dialogs.ResponseDialog;
...
public class LauncherUtils {
    ...
    public static Bootstrap bootstrap = new Bootstrap("https://github.com/pbellchambers/Mace-Swinger/assets/changelog.xml");
    ...
    public static void downloadGame() {
        ...
        try {
            ...
            downloader.download("https://github.com/pbellchambers/Mace-Swinger/assets/MaceSwinger.jar", Resources.gamePath, false, Resources.foreground);
            for (String file : lwjglFiles) {
                System.out.println("Downloading " + file);
                downloader.download("https://github.com/pbellchambers/Mace-Swinger/assets/lwjgl/" + file, OSUtils.getDynamicStorageLocation() + "Mace Swinger/lwjgl/" + file, false);
            }
...
//        return new File(Resources.gamePath).exists();
    ...
    public static String connect(String php, String[] keys, String[] values) throws Exception {
        ...
        String url = "https://github.com/pbellchambers/Mace-Swinger/" + php + ".php" + query;
