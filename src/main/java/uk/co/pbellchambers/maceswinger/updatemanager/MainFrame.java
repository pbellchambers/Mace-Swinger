package uk.co.pbellchambers.maceswinger.updatemanager;
...
public class MainFrame extends JFrame
{
	...
	private void getChangelog()
	{
		try
		{
			doc = DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new InputSource(new URL("https://github.com/pbellchambers/Mace-Swinger/assets/changelog.xml").openStream()));
