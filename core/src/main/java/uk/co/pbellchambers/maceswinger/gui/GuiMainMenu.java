...
import uk.co.pbellchambers.maceswinger.gui.components.GuiButtonArray;
import uk.co.pbellchambers.maceswinger.gui.components.GuiTexturedButtonArray;
import uk.co.pbellchambers.maceswinger.items.ItemMace;
...
import uk.co.pbellchambers.maceswinger.utils.EnumTextures;
    ...
    public void guiActionPerformed(int elementId, int action) {
        switch (elementId) {
            ...
            case 3:
                ...
                break;
            case 4:
                OSUtils.browse("http://github.com/pbellchambers/Mace-Swinger");
